...
/*
    TalariaScan: implements the spark connector Scan interface providing the
    methods to fetch table schema(the data-types of columns) and also what to do
    in the context of Batch, MicroBatch and ContinuosStream scenarios.
 */
